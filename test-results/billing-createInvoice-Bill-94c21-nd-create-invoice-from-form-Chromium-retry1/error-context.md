...
- Name: billing\createInvoice.spec.ts >> Billing - Invoice scenarios >> should open an existing bill and create invoice from form
- Location: tests\billing\createInvoice.spec.ts:5:7
